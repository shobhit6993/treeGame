...
-- User plays first. Then Computer plays
-- Player C is Computer. Player U is user.
-- Player U can remove Red or Blue; Player C can remove Green or Blue
...
gameLoop state id = do
	...
	where 
		compMove = computerMove state id
--------------------------------------------------------------
